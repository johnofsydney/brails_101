...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference("Measurement.count") do
      post measurements_url, params: { measurement: { humidity: @measurement.humidity, temperature: @measurement.temperature } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { humidity: @measurement.humidity, temperature: @measurement.temperature } }
